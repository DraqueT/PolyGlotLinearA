...
JAVAFX_LOCATION="/Users/user/.m2/repository/org/openjfx"
JAVAFX_VER="12.0.2"
JAVA_PACKAGER_LOCATION="/Java/jdk-14/bin" # This will go away once Java 14 drops officially...
JAR_W_DEP="PolyGlotLinA-3.0-jar-with-dependencies.jar"
JAR_WO_DEP="PolyGlotLinA-3.0.jar"
JAVA_HOME="/Java/jdk-12.0.2" # Windows is stupid, so I do this manually.
