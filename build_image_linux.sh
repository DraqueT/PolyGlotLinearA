...
if [ "$1" = "" ] || [ "$1" = "image" ]; then
	...
	$JAVA_PACKAGER_LOCATION/jlink --module-path "module_injected_jars/:target/mods:$JAVAFX_LOCATION_LINUX/javafx-graphics/$JAVAFX_VER/:$JAVAFX_LOCATION_LINUX/javafx-base/$JAVAFX_VER/:$JAVAFX_LOCATION_LINUX/javafx-media/12.0.2/:$JAVAFX_LOCATION_LINUX/javafx-swing/$JAVAFX_VER/:$JAVAFX_LOCATION_LINUX/javafx-controls/$JAVAFX_VER/:$JAVA_HOME/jmods" --add-modules "org.darisadesigns.polyglotlina.polyglot","jdk.crypto.ec" --output "build/image/" --compress=2 --launcher PolyGlot=org.darisadesigns.polyglotlina.polyglot
fi
